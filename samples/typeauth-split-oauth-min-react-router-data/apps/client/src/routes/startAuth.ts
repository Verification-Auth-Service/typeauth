...
import { randomVerifier, challengeS256 } from "../lib/pkce";
import { saveState, saveVerifier } from "../lib/storage";

export async function startAuthRedirect(_args: LoaderFunctionArgs) {
  ...
  authorize.searchParams.set("client_id", AUDIENCE);
